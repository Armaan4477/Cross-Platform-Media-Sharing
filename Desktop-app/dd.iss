...
[Run]
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall add rule name=""DataDash UDP 49185"" dir=in action=allow protocol=UDP localport=49185"; Flags: runhidden;
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall add rule name=""DataDash UDP 49186"" dir=in action=allow protocol=UDP localport=49186"; Flags: runhidden;
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall add rule name=""DataDash TCP 49185"" dir=in action=allow protocol=TCP localport=49185"; Flags: runhidden;
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall add rule name=""DataDash TCP 49186"" dir=in action=allow protocol=TCP localport=49186"; Flags: runhidden;
...
[UninstallRun]
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall delete rule name=""DataDash UDP 49185"""; Flags: runhidden;
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall delete rule name=""DataDash UDP 49186"""; Flags: runhidden;
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall delete rule name=""DataDash TCP 49185"""; Flags: runhidden;
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall delete rule name=""DataDash TCP 49186"""; Flags: runhidden;
