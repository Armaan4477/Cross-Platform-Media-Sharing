...
current_version = "5.5.6"  # Set the current version of the json config file
app_version = "3.3.4"  # Set the current version of the application, note: while incrementing app_version, also increment current_version otherwise the app_version wont update for users.
